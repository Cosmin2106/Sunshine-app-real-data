...
public final class NetworkUtils {
    ...
    // Choose one of the links to switch between data sources
    public static final String FORECAST_BASE_URL = OPEN_WEATHER_MAP_URL;
    ...
    /* TODO: Please do not use my key and generate your own after creating an account on the OpenWeatherMap website.
       Without it, the app won't work. */
    private static final String weather_url_key = "871abcef960e204e091417364550614d";
    ...
    private static URL buildUrlWithLatitudeLongitude(Double latitude, Double longitude) {
        Uri weatherQueryUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                ...
                .appendQueryParameter(KEY_PARAM, weather_url_key)
                .build();
